...
public class WizardUtils {
	...
	private static void initWizards() {
		...
		if(CustomDistribution.distributionWantsOtherProviders()) {
			...
			WIZARDS_DICT.put("VATS", new WizardInfo("VATS", "ВАТС",
					R.drawable.ic_wizard_vats, 10,
					new Locale[] {
							locale("ru_RU")
					}, false, false,
					Advanced.class));
			...
			WIZARDS_DICT.put("DIALOG", new WizardInfo("DIALOG", "Диалог",
					R.drawable.ic_wizard_dialog, 10,
					new Locale[]{
							locale("ru_RU")
					}, false, false, 
					Sipnet.class));
